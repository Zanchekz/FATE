...
#ui funcs
def eidoGettingUp():
    if currentSet.terry.lastLimbTimeSeconds != 0 and currentSet.terry.capshotTime == 0:
        terryCapshotTextDisplay.configure(text = "Capshot Time!")
    elif currentSet.garry.lastLimbTimeSeconds != 0 and currentSet.garry.capshotTime == 0:
        garryCapshotDisplay.configure(text = "Capshot Time!")
    elif currentSet.harry.lastLimbTimeSeconds != 0 and currentSet.harry.capshotTime == 0:
        harryCapshotDisplay.configure(text = "Capshot Time!")
        ...
        while "\n" in line:
            ...
            # Rest of limbs
                ...
                if currentLimb < 5:
                    ...
                    currentSet.garry.timer_task_id = app.after(37000, eidoGettingUp)
        ...
        while "\n" in line:
            ...
            # Rest of limbs
                ...
                if currentLimb < 5:
                    ...
                    currentSet.harry.timer_task_id = app.after(37000, eidoGettingUp)
            ...
            # Capture 
                ...
                app.after_cancel(currentSet.harry.timer_task_id)
                harryCapshotDisplay.configure(text = "??")
